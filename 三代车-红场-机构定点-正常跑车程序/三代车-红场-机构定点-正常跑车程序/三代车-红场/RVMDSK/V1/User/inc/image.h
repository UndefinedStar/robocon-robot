...
extern s16 speed_left,speed_hd1,speed_hd5,speed_xp,speed_stop1,speed_stop2,speed_stop4,speed_last2,speed_sc,speed_last,speed_now,speed_now_hd5;
...
extern int zj_speed,speed_time,zj_sc_count,beep_send_flag,beep_count_send,beep_time_send;
extern int center_average;
extern int zj_time,hand_time,time_axial;
extern u8 XpHuorStartFlag,UVFlag;
extern int XPStopToHandFlag;
extern int xp_threshold_value,xp_value_sub;
