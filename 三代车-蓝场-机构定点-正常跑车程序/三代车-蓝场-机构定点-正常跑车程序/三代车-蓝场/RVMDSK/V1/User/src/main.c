...
//		if(speed_stop2>0&&HuorDistance-speed_stop2>XpScDistance&&hand_restart==0&&speed_now==0)
//			stop_time++;
//		if(hand_restart==2)
//			stop_time++;
		if(left_angle_flag==1&&sp_flag==1&&zj_keep_flag==1)
			zj_time++;
		//framecount=0;
