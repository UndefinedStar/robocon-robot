...
/****************************************************************************
* 名    称：void GUI_Text_16x24(u16 x, u16 y, u8 *str, u16 len,u16 Color, u16 bkColor)
* 功    能：在指定座标显示16x24字符串
* 入口参数：x      行座标
*           y      列座标
*           *str   字符串
...
* 出口参数：无
* 说    明：
* 调用方法：GUI_Text_16x24(0,0,"0123456789",10,0x0000,0xffff);
****************************************************************************/
void GUI_Text_16x24(u16 x, u16 y, u8 *str, u16 len,u16 Color, u16 bkColor)
{
  u8 i;
