...
s16 CarBehindPoint = 0, PathPoint = 0, AnglePoint = 0, LineY = 0,
    BazierAngle1 = 0, BazierLength1 = 0, BazierLength2 = 0, BazierAngle2 = 0,CarBehindStartX=0;
...
s8  Switch_SpeedDown = 0;
s8  Switch_Magnetic = 1;
s8  LineCameraCorrent = 0;
s8  DT50LineStandar = 47;
s8  DT50Speed = 3;
s8  Switch_DT50Line = 1;
u16  Vbegin = 100;
u16  Abegin=200;
u16 FanSpeedDown=200;
u16 GyroscopeCoefficientX = 575;
u16 GyroscopeCoefficientY = 1327;
s8 Switch_Climb=1;
...
void LCDAdjust(void)
{
    ...
    if(Adjust[AdjustKey] == 1)
        Cylinder(0xff, 0xff, 'W');
    if(Adjust[AdjustKey] == 3)
        Cylinder(0xff, 0x00, 'W');
    if(Adjust[AdjustKey] == 9)
    {
    ...
    if(Adjust[AdjustKey] == 7)
	  ...
	  if(Adjust[AdjustKey] == 14)
        ChangeMotor(0x162,RunMotor);
		else if(Adjust[AdjustKey] == 15)
			ChangeMotor(0x163,RunMotor);
		else if(Adjust[AdjustKey] == 16)
			ChangeMotor(0x164,RunMotor);
    ...
    if(Adjust[Page] == 0)
    {
        ...
        GUI_Text_16x24(5, 150, (u8*)"BazierAngle2:", 13, Blue, Green);
        GUI_Text_16x24(5, 180, (u8*)"Switch_Magnetic:", 16, Blue, Green);
        GUI_Text_16x24(5, 210, (u8*)"DT50Speed:", 10, Blue, Green);
        ...
        sprintf(str_Vangle, "%3d", (int)BazierAngle2);
        sprintf(str_CurrentV, "%d", (int)Switch_Magnetic);
        sprintf(str_Camera, "%3d", (int)DT50Speed);
        ...
        GUI_Text_16x24(290, 180, (u8*)str_CurrentV, 1, 0x0000, Green);
        ...
        {
            case 1:
                CarBehindPoint += 3 * Adjust[Calculate];
                sprintf(str_x, "%3d", (int)CarBehindPoint);
                GUI_Text_16x24(260, 0, (u8*)str_x , 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 0, (u8*)"CarBehindPoint:", 15, Blue, Yellow);
                break;
            case 2:
                PathPoint += 3 * Adjust[Calculate];
                sprintf(str_y, "%3d", (int)PathPoint);
                GUI_Text_16x24(260, 30, (u8*)str_y , 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 30, (u8*)"PathPoint:", 10, Blue, Yellow);
                break;
            case 3:
                AnglePoint += 3 * Adjust[Calculate];
                sprintf(str_angle, "%3d", (int)AnglePoint);
                GUI_Text_16x24(260, 60, (u8*)str_angle, 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 60, (u8*)"AnglePoint:", 11, Blue, Yellow);
                break;
            case 4:
                LineY += 3 * Adjust[Calculate];
                sprintf(str_Vx, "%3d", (int)LineY);
                GUI_Text_16x24(260, 90, (u8*)str_Vx, 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 90, (u8*)"LineY:", 6, Blue, Yellow);
                break;
            case 5:
                BazierLength2 += 5 * Adjust[Calculate];
                sprintf(str_Vy, "%3d", (int)BazierLength2);
                GUI_Text_16x24(260, 120, (u8*)str_Vy, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 120, (u8*)"BazierLength2:", 14, Blue, Yellow);
                break;
            case 6:
                BazierAngle2 += 3 * Adjust[Calculate];
                sprintf(str_Vangle, "%3d", (int)BazierAngle2);
                GUI_Text_16x24(260, 150, (u8*)str_Vangle, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 150, (u8*)"BazierAngle2:", 13, Blue, Yellow);
                break;
            case 7:
                Switch_Magnetic += Adjust[Calculate];
                if(Switch_Magnetic > 1)
                    Switch_Magnetic = 0;
                else if(Switch_Magnetic < 0)
                    Switch_Magnetic = 1;
                sprintf(str_CurrentV, "%d", (int)Switch_Magnetic);
                GUI_Text_16x24(290, 180, (u8*)str_CurrentV, 1, 0x0000, Yellow);
                GUI_Text_16x24(5, 180, (u8*)"Switch_Magnetic:", 16, Blue, Yellow);
                break;
            case 8:
                DT50Speed += Adjust[Calculate];
                sprintf(str_Camera, "%3d", (int)DT50Speed);
                GUI_Text_16x24(260, 210, (u8*)str_Camera, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 210, (u8*)"DT50Speed:", 10, Blue, Yellow);
                break;
            default:
                break;
        }
    ...
    else if(Adjust[Page] == 1)
    {
        ...
        {
            case 1:
                RiverTimeLimit += 5 * Adjust[Calculate];
                sprintf(str_x, "%3d", (int)RiverTimeLimit);
                GUI_Text_16x24(260, 0, (u8*)str_x , 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 0, (u8*)"RiverTimeLimit:", 15, Blue, Yellow);
                break;
            case 2:
                PutFanLimit += 5 * Adjust[Calculate];
                sprintf(str_y, "%3d", (int)PutFanLimit);
                GUI_Text_16x24(260, 30, (u8*)str_y , 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 30, (u8*)"PutFanLimit:", 11, Blue, Yellow);
                break;
            case 3:
                RiverTimeDown += 5 * Adjust[Calculate];
                sprintf(str_angle, "%3d", (int)RiverTimeDown);
                GUI_Text_16x24(260, 60, (u8*)str_angle, 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 60, (u8*)"RiverTimeDown:", 14, Blue, Yellow);
                break;
            case 4:
                FanSpeedFour += Adjust[Calculate];
                sprintf(str_Vx, "%3d", (int)FanSpeedFour);
                GUI_Text_16x24(260, 90, (u8*)str_Vx, 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 90, (u8*)"FanSpeedFour:", 13, Blue, Yellow);
                break;
            case 5:
                ClimbTimeLimit += 5 * Adjust[Calculate];
                sprintf(str_Vx, "%3d", (int)ClimbTimeLimit);
                GUI_Text_16x24(260, 120, (u8*)str_Vy, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 120, (u8*)"ClimbTimeLimit:", 15, Blue, Yellow);
                break;
            case 6:
                ClimbDownLimit += 5 * Adjust[Calculate];
                sprintf(str_Vx, "%3d", (int)ClimbDownLimit);
                GUI_Text_16x24(260, 150, (u8*)str_Vangle, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 150, (u8*)"ClimbDownLimit:", 15, Blue, Yellow);
                break;
            case 7:
                BazierAngle1 += 5 * Adjust[Calculate];
                sprintf(str_CurrentV, "%3d", (int)BazierAngle1);
                GUI_Text_16x24(260, 180, (u8*)str_CurrentV, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 180, (u8*)"BazierAngle1:", 13, Blue, Yellow);
                break;
            case 8:
                BazierLength1 += 5 * Adjust[Calculate];
                sprintf(str_Camera, "%3d", (int)BazierLength1);
                GUI_Text_16x24(260, 210, (u8*)str_Camera, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 210, (u8*)"BazierLength1:", 14, Blue, Yellow);
                break;
            default:
                break;
        }
    ...
    else if(Adjust[Page] == 2)
    {
        ...
        GUI_Text_16x24(5, 180, (u8*)"DT50LineStandar:", 16, Blue, Green);
        GUI_Text_16x24(5, 210, (u8*)"Switch_SpeedDown:", 17, Blue, Green);
        ...
        sprintf(str_CurrentV, "%3d", (int)DT50LineStandar);
        sprintf(str_Camera, "%d", (int)Switch_SpeedDown);
        ...
        GUI_Text_16x24(260, 180, (u8*)str_CurrentV, 3, 0x0000, Green);
        GUI_Text_16x24(290, 210, (u8*)str_Camera, 1, 0x0000, Green);

        switch (Adjust[PageCoulum])
        {
            case 1:
                Switch_ClimbDown += Adjust[Calculate];
                ...
                GUI_Text_16x24(5, 0, (u8*)"Switch_ClimbDown:", 17, Blue, Yellow);
                break;
            case 2:
                Switch_DT50 += Adjust[Calculate];
                if(Switch_DT50 > 1)
                    Switch_DT50 = 0;
                ...
                GUI_Text_16x24(5, 30, (u8*)"Switch_DT50:", 11, Blue, Yellow);
                break;
            case 3:
                Switch_Computer += Adjust[Calculate];
                ...
                GUI_Text_16x24(5, 60, (u8*)"Switch_Computer:", 16, Blue, Yellow);
                break;
            case 4:
                LineCameraCorrent += Adjust[Calculate];
                sprintf(str_Vx, "%2d", (int)LineCameraCorrent);
                GUI_Text_16x24(290, 90, (u8*)str_Vx, 2, 0x0000, Yellow);
                GUI_Text_16x24(5, 90, (u8*)"LineCameraCorrent:", 18, Blue, Yellow);
                break;
            case 5:
                Flagu16[HandTime] += 5 * Adjust[Calculate];
                sprintf(str_Vx, "%3d", (int)Flagu16[HandTime]);
                GUI_Text_16x24(260, 120, (u8*)str_Vy, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 120, (u8*)"HandTime:", 9, Blue, Yellow);
                break;
            case 6:
                Flagu16[MotorPutFanSpeedBlue] += 500 * Adjust[Calculate];
                sprintf(str_Vx, "%4d", (int)Flagu16[MotorPutFanSpeedBlue]);
                GUI_Text_16x24(260, 150, (u8*)str_Vangle, 4, 0x0000, Yellow);
                GUI_Text_16x24(5, 150, (u8*)"PutFanSpeedBlue:", 15, Blue, Yellow);
                break;
            case 7:
                DT50LineStandar += Adjust[Calculate];
                sprintf(str_CurrentV, "%3d", (int)DT50LineStandar);
                GUI_Text_16x24(260, 180, (u8*)str_CurrentV, 3, 0x0000, Yellow);
                GUI_Text_16x24(5, 180, (u8*)"DT50LineStandar:", 16, Blue, Yellow);
                break;
            case 8:
                Switch_SpeedDown += Adjust[Calculate];
                if(Switch_SpeedDown > 1)
                    Switch_SpeedDown = 0;
                else if(Switch_SpeedDown < 0)
                    Switch_SpeedDown = 1;
                sprintf(str_Camera, "%d", (int)Switch_SpeedDown);
                GUI_Text_16x24(290, 210, (u8*)str_Camera, 1, 0x0000, Yellow);
                GUI_Text_16x24(5, 210, (u8*)"Switch_SpeedDown:", 17, Blue, Yellow);
                break;
            default:
                break;
        }
    }
    else if(Adjust[Page] == 3)
    {
        GUI_Text_16x24(5, 0, (u8*)"Switch_DT50Line:", 16, Blue, Green);
        GUI_Text_16x24(5, 30, (u8*)"GyroscopeX:",11,Blue, Green);
        GUI_Text_16x24(5, 60, (u8*)"GyroscopeY:",11,Blue, Green);
        GUI_Text_16x24(5, 90, (u8*)"CarBehindStartX:",16,Blue, Green);
          GUI_Text_16x24(5, 120, (u8*)"Vbegin:",7,Blue, Green);
      GUI_Text_16x24(5, 150, (u8*)"Abegin:",7,Blue, Green);
        GUI_Text_16x24(5, 180, (u8*)"FanSpeedDown:",13,Blue, Green);
          GUI_Text_16x24(5, 210, (u8*)"Switch_Climb:",13,Blue, Green);

        sprintf(str_x, "%d", (int)Switch_DT50Line);
        sprintf(str_y,"%3d",(int)GyroscopeCoefficientX);
        sprintf(str_angle,"%4d",(int)GyroscopeCoefficientY);
          sprintf(str_Vx,"%2d",(int)CarBehindStartX);
          sprintf(str_Vy,"%3d",(int)Vbegin);
          sprintf(str_Vangle,"%3d",(int)Abegin);
        sprintf(str_CurrentV,"%3d",(int)FanSpeedDown);
          sprintf(str_Camera,"%d",(int)Switch_Climb);

        GUI_Text_16x24(280, 0, (u8*)str_x , 1, 0x0000, Green);
        GUI_Text_16x24(260, 30, (u8*)str_y ,3,0x0000, Green);
        GUI_Text_16x24(260, 60, (u8*)str_angle,4,0x0000, Green);
				GUI_Text_16x24(280, 90, (u8*)str_Vx,2,0x0000, Green);
				GUI_Text_16x24(260, 120, (u8*)str_Vy,3,0x0000, Green);
				GUI_Text_16x24(260, 150, (u8*)str_Vangle,3,0x0000, Green);
				GUI_Text_16x24(260, 180, (u8*)str_CurrentV,3,0x0000, Green);
        GUI_Text_16x24(260, 210, (u8*)str_Camera,1,0x0000, Green);

        switch (Adjust[PageCoulum])
        {
            case 1:
                Switch_DT50Line += Adjust[Calculate];
                if(Switch_DT50Line > 1)
                    Switch_DT50Line = 0;
                else if(Switch_DT50Line < 0)
                    Switch_DT50Line = 1;
                sprintf(str_x, "%d", (int)Switch_DT50Line);
                GUI_Text_16x24(280, 0, (u8*)str_x , 1, 0x0000, Yellow);
                GUI_Text_16x24(5, 0, (u8*)"Switch_DT50Line:", 16, Blue, Yellow);
                break;
              case 2:GyroscopeCoefficientX += 3*Adjust[Calculate];
                       sprintf(str_y,"%3d",(int)GyroscopeCoefficientX);
                     GUI_Text_16x24(260, 30, (u8*)str_y ,3,0x0000, Yellow);
                           GUI_Text_16x24(5, 30, (u8*)"GyroscopeX:",11,Blue, Yellow);break;
              case 3:GyroscopeCoefficientY += 3*Adjust[Calculate];
                
                     sprintf(str_angle,"%4d",(int)GyroscopeCoefficientY);
                       GUI_Text_16x24(260, 60, (u8*)str_angle,4,0x0000, Yellow);
                           GUI_Text_16x24(5, 60, (u8*)"GyroscopeY:",11,Blue, Yellow);break;
              case 4:CarBehindStartX+=3*Adjust[Calculate];
                      sprintf(str_Vx,"%2d",(int)CarBehindStartX);
                     GUI_Text_16x24(280, 90, (u8*)str_Vx,2,0x0000, Yellow);
                     GUI_Text_16x24(5, 90, (u8*)"CarBehindStartX:",16,Blue, Yellow);break;
              case 5:Vbegin+=10*Adjust[Calculate];
                       sprintf(str_Vy,"%3d",(int)Vbegin);
                     GUI_Text_16x24(260, 120, (u8*)str_Vy,3,0x0000, Yellow);
                     GUI_Text_16x24(5, 120, (u8*)"Vbegin:",7,Blue, Yellow);break;
              case 6:Abegin+=10*Adjust[Calculate];
                       sprintf(str_Vangle,"%3d",(int)Abegin);
                     GUI_Text_16x24(260, 150, (u8*)str_Vangle,3,0x0000, Yellow);
                     GUI_Text_16x24(5, 150, (u8*)"Abegin:",7,Blue, Yellow);break;
              case 7:FanSpeedDown+=50*Adjust[Calculate];
                       sprintf(str_CurrentV,"%3d",(int)FanSpeedDown);
                     GUI_Text_16x24(260, 180, (u8*)str_CurrentV,3,0x0000, Yellow);
                     GUI_Text_16x24(5, 180, (u8*)"FanSpeedDown:",13,Blue, Yellow);break;
            case 8:Switch_Climb+=Adjust[Calculate];
                           if(Switch_Climb>1)
                               Switch_Climb=0;
                           else if(Switch_Climb<0)
                               Switch_Climb=1;
                     sprintf(str_Camera,"%d",(int)Switch_Climb);
                     GUI_Text_16x24(260, 210, (u8*)str_Camera,1,0x0000, Yellow);
                     GUI_Text_16x24(5, 210, (u8*)"Switch_Climb:",13,Blue, Yellow);break;
            default:
                break;
        }
    }
...
//          GUI_Text_16x24(210, 150, (u8*)str_Number,7,0x0000, Green);
        ...
        if(ErrorShow == 1)
        {
            ...
            else if(CameraDistance <= 0 || Dt50ScanDistance <= 0)
            {
...
//          GUI_Text_16x24(5, 60, (u8*)"Vy:",3,Blue, Green);
        ...
        GUI_Text_16x24(5, 150, (u8*)"SpeedDownTime:", 14, Blue, Green);
		  	GUI_Text_16x24(5, 180, (u8*)"FanSpeedChange:", 15, Blue, Green);
        GUI_Text_16x24(5, 210, (u8*)"Switch_DT50:", 12, Blue, Green);
//          GUI_Text_16x24(165, 30, (u8*)"CA:",3,Blue, Green);
//          GUI_Text_16x24(165, 30, (u8*)"LX:",3,Blue, Green);
//          GUI_Text_16x24(165, 60, (u8*)"LY:",3,Blue, Green);
//          GUI_Text_16x24(165, 90, (u8*)"LA:",3,Blue, Green);
...
//          GUI_Text_16x24(165, 180, (u8*)"KY:",3,Blue, Green);
        ...
        sprintf(str_can, "%d", Flag[FanSpeedChangeByDT50] );
        sprintf(str_LockX, "%d", Switch_DT50);
//          sprintf(str_LockY,"%7.2f",LockPoint.y);
//          sprintf(str_LockA,"%7.2f",LockPoint.angle);
//          sprintf(str_Number,"%7.2f",(float)CanGroup);
//          sprintf(str_Key,"%7.2f",(float)ErrorCameraWidth);
        ...
        GUI_Text_16x24(260, 180, (u8*)str_can, 1, 0x0000, Green);
        GUI_Text_16x24(260, 210, (u8*)str_LockX, 1, 0x0000, Green);
//          GUI_Text_16x24(210, 30, (u8*)str_Camera,7,0x0000, Green);
//          GUI_Text_16x24(210, 30, (u8*)str_LockX,7,0x0000, Green);
//          GUI_Text_16x24(210, 60, (u8*)str_LockY,7,0x0000, Green);
//          GUI_Text_16x24(210, 90, (u8*)str_LockA,7,0x0000, Green);
