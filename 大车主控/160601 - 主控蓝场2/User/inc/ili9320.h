...
#define LCD_BASE   ((u32)(0x60000000 | 0x0C000000)|0x00000000)			//最后的或取决于地址线用的是哪个
...
//硬件相关的子函数 背光控制
#define Lcd_Light_ON   GPIO_SetBits(GPIOD, GPIO_Pin_6)
#define Lcd_Light_OFF  GPIO_ResetBits(GPIOD, GPIO_Pin_6)
