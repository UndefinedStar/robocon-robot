...
//			else if((HandKey&0x1000)==0 && (HandKey&0x2000)==0)
//			{
//				StartStteringEngine(StteringEngineLeft,StteringEngineLeftUp);
//				StartStteringEngine(StteringEngineRight,StteringEngineRightUp);
//			}
//			else if((HandKey&0x1000)==0 && (HandKey&0x4000)==0)
//			{
//				StartStteringEngine(StteringEngineLeft,StteringEngineLeftDown);
//				StartStteringEngine(StteringEngineRight,StteringEngineRightDown);
//			}
